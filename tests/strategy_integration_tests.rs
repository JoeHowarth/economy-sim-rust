...
fn test_survival_strategy_prioritizes_resources() {
    ...
    println!(
        "Survival allocation: food={}, wood={}, construction={}",
    ...
    assert!(
        ...
        "Should allocate to food production"
    );
    // May allocate all to food if it's the most critical need
    assert!(
        decision.allocation.food + decision.allocation.wood > dec!(0),
    ...
    assert!(
        decision.food_bid.is_some() || decision.wood_bid.is_some(),
...
fn test_growth_strategy_builds_houses() {
    ...
    println!(
        "Growth allocation: food={}, wood={}, construction={}",
        decision.allocation.food, decision.allocation.wood, decision.allocation.construction
    );
...
fn test_trading_strategy_specializes() {
    ...
    assert!(
        decision_food.food_ask.is_some(),
        "Food specialist should sell food"
    );
    ...
    assert!(
        decision_wood.wood_ask.is_some(),
        "Wood specialist should sell wood"
    );
}
...
fn test_greedy_strategy_maximizes_value() {
    ...
    println!(
        "Greedy allocation (wood high): food={}, wood={}, construction={}",
        decision.allocation.food, decision.allocation.wood, decision.allocation.construction
    );
    ...
    println!(
        "Greedy allocation (food high): food={}, wood={}, construction={}",
